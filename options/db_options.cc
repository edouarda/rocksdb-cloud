...
static std::unordered_map<std::string, OptionTypeInfo>
    db_immutable_options_type_info = {
        ...
        {"max_background_flushes",
         {offsetof(struct ImmutableDBOptions, max_background_flushes),
          OptionType::kInt, OptionVerificationType::kNormal,
          OptionTypeFlags::kNone}},
        ...
        {"wal_dir",
         {offsetof(struct ImmutableDBOptions, wal_dir), OptionType::kString,
          OptionVerificationType::kNormal, OptionTypeFlags::kNone}},
        {"max_subcompactions",
         {offsetof(struct ImmutableDBOptions, max_subcompactions),
         ...
         { offsetof(struct ImmutableDBOptions, env),
          ...
          (OptionTypeFlags::kPointer | OptionTypeFlags::kCompareNever),
           [](const std::string& /*name*/, const std::string& value,
             ...
             Status s = Env::CreateFromString(value, opts, env);
             if (s.ok()) {
...
class DBOptionsConfigurable : public MutableDBConfigurable {
 ...
 protected:
  Status DoConfigureFromMap(
    ...
    Status s =
        MutableDBConfigurable::DoConfigureFromMap(opts_map, options, unused);
    if (s.ok()) {
